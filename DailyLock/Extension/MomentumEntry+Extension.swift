...
extension MomentumEntry {
    static var samples: [MomentumEntry] {
        [
            MomentumEntry(date: Date().addingTimeInterval(-86400 * 30*2), text: "Lost motivation and skipped tasks.", sentiment: .neutral, lockedAt: Date().addingTimeInterval(-86400 * 30*2)),
            ...
            MomentumEntry(date: Date().addingTimeInterval(-86400 * 8), text: "Work was challenging but I managed the stress.", sentiment: .neutral,lockedAt: Date().addingTimeInterval(-86400 * 8)),
            ...
            MomentumEntry(date: Date().addingTimeInterval(-86400 * 5), text: "Productive day with a few interruptions.", sentiment: .neutral, lockedAt: Date().addingTimeInterval(-86400 * 5)),
            ...
            MomentumEntry(date: Date().addingTimeInterval(-86400 * 2), text: "Average day, nothing much to note.", sentiment: .neutral, lockedAt: Date().addingTimeInterval(-86400 * 2)),
